...
- Name: auth.spec.js >> Authentication Flows >> Cadet (Student) Login >> should successfully login and navigate to dashboard with valid credentials
- Location: tests\e2e\auth.spec.js:28:5
