    ...
    <div className="min-h-screen bg-[#FDFCF8] flex items-center justify-center p-5 font-ui relative overflow-hidden">
      <div className="bg-white border border-stone-deep rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] w-full max-w-[420px] p-10 relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-ink-4 text-[13px] font-normal">Authorized Access Only</p>
        </div>


        <form onSubmit={handleSubmit}>
          <div className="mb-5">
            <label htmlFor="login-email" className="block font-mono text-[10px] tracking-[0.1em] uppercase text-ink-3 mb-1.5">Email Address</label>
          ...
          <div className="mb-8">
            <label htmlFor="login-password" className="block font-mono text-[10px] tracking-[0.1em] uppercase text-ink-3 mb-1.5">Password</label>
            <div className="relative">
              <input
                id="login-password"
                type="password"
