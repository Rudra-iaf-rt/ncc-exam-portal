...
- Name: auth.spec.js >> Authentication Flows >> Admin Login >> should successfully login and navigate to admin dashboard with valid credentials
- Location: tests\e2e\auth.spec.js:58:5
